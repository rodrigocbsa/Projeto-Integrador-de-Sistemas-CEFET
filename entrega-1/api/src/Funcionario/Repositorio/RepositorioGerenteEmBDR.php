    ...
    public function cadastrarFuncionarioComLogin($usuario,$nome_funcionario): bool{
        try {
            ...
            $sql = '
                ...
                INSERT INTO login(usuario,senha,acesso,sal,pimenta) VALUES (:usuario,:hash,:acesso,:sal,:pimenta);

                INSERT INTO funcionario(nome,login) VALUES (:nome,(SELECT id FROM login WHERE usuario = :usuario AND senha = :hash))
            ';
            ...
            throw new RepositorioException( 'Erro ao adicionar o funcionário no banco de dados.', (int) $ex->getCode(), $ex );
        }
    }
