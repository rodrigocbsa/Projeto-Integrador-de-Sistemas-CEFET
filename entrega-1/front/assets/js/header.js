            ...
            <div class="row">
                ...
                <div class="header-right">
                    ...
                    <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                        ...
                        <div class="info">
                            <div class="image">
                            <img src="/front/assets/images/profile/profile-image.png" alt="" />
                            </div>
                            <div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                        ...
                        <div class="author-info flex items-center !p-1">
                            <div class="image">
                            <img src="/front/assets/images/profile/profile-image.png" alt="image">
                            </div>
                            <div class="content">
                            <h4 class="text-sm">${sessionStorage.getItem('nome')}</h4>
                            <a class="text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white text-xs">Seu id: ${sessionStorage.getItem('id')}</a>
                            </div>
                        </div>
                        </li>
                        <li class="divider"></li>
                        <li>
                        <a href="funcionarios.html"> <i class="lni lni-exit"></i> Cadastrar Funcionários </a>
                        </li>
                        <li>
