    ...
    iniciar(){
        ...
        botaoPedido.onclick = (event: Event) => {
            ...
            if(!this.camposEstaoVazios())  
              ...
              this.exibirNotificacao(["Preencha os dados para adicionar um pedido a uma mesa."],'warning');
        }
        ...
        botaoItem.onclick = (event: Event) => {
            ...
            if(selectMesas.selectedIndex != 0)
                ...
                this.exibirNotificacao(["Selecione uma mesa de atendimento para adicionar itens ao pedido."],'warning')
        }
