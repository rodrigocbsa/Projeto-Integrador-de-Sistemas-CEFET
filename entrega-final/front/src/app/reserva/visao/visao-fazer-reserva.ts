  ...
  iniciar() {
    ...
    inputHora.onblur = () => {
      if(inputData.value && inputHora.value) {
        ...
        this.exibirNotificacao(["Favor preencher a data e a hora para pesquisar as mesas."],TIPOS_NOTIFICACAO.AVISO);
      }
    };
    ...
    botaoCadastrar.onclick = (event: Event) => {
      ...
      if(this.camposEstaoVazios() == false)
        ...
        this.exibirNotificacao(["É necessário preencher todos os campos."],TIPOS_NOTIFICACAO.AVISO);
    };
