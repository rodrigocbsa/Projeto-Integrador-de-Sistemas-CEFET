...
$app->get( '/reservas', $middlewareIsLogado, function( $req, $res ) use ( $pdo ) 
{
...
$app->get('/reserva/:id', $middlewareIsLogado, function( $req, $res ) use ( $pdo )
{
    $controller = criarControladoraReserva($pdo);
...
$app->put('/reserva/:id', $middlewareIsLogado, function( $req, $res ) use ( $pdo )
{
    $controller = criarControladoraReserva($pdo);
...
$app->put('/reserva/concluir/:id', $middlewareIsGerente, function( $req, $res ) use ( $pdo )
{
    $controller = criarControladoraReserva($pdo);
...
$app->post( '/reservas', $middlewareIsLogado, function( $req, $res ) use ( $pdo ) 
{
